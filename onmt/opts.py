...
def model_opts(parser):
    ...
    group.add_argument('-max_src_len', type=int, default=40,
                       help='Max len for src data.')  # yue
    group.add_argument('-max_conv_len', type=int, default=80,
                       help='Max len for conversation.')  # yue
    ...
    group.add_argument('-encoder_type', type=str, default='transformer',
                       choices=['BiAttEncoder', 'PostEncoder', 'transformer'],
...
def preprocess_opts(parser):
    ...
    group.add_argument('-src_vocab', default="",
                       ...
                       one word per line.""")
    group.add_argument('-conversation_vocab', default="",
                       help="""Path to an existing conversation vocabulary. Format:
                           one word per line.""")
    ...
    group.add_argument('-conversation_vocab_size', type=int, default=50000,
    ...
    group.add_argument('-conversation_words_min_frequency', type=int, default=0)
    ...
    group.add_argument('-conversation_seq_length', type=int, default=50,
                       help="Maximum conversation sequence length")
    group.add_argument('-conversation_seq_length_trunc', type=int, default=0,
...
def train_opts(parser):
    ...
    group.add_argument('-learning_rate_decay', type=float, default=0.5,
                       ...
                       start_decay_at""")
    group.add_argument('-start_decay_at', type=int, default=None,
...
def translate_opts(parser):
    ...
    group.add_argument('-src_dir',   default="",
                       help='Source directory for image or audio files')
    group.add_argument('-conversation', default="",
